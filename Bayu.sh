...
echo -e "  Auther : ${green}Bayu vpn® ${NC}${YELLOW}(${NC} ${green} Yass vpn Tunneling ${NC}${YELLOW})${NC}"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER🐳","url":"https://t.me/BayuVpnStore"},{"text":"GROUP🐬","url":"https://chat.whatsapp.com/HiuYU3W4Bq3FWOxsWcGNsM"}]]}'
